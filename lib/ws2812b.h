...
/**
 * @brief Desenha uma imagem (glyph) na matriz de LEDs com base nos valores RGB.
 * * @param ws Ponteiro para a estrutura `ws2812b_t`.
 * @param glyph A matriz de 25 elementos representando a imagem.
